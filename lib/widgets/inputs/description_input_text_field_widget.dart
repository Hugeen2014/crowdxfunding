...
class DescriptionInputTextFieldWidget extends StatelessWidget {
  ...
  const DescriptionInputTextFieldWidget({
    super.key,
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        border: OutlineInputBorder(
          ...
          borderSide: const BorderSide(color: CustomColor.whiteColor, width: 1),
        ),
