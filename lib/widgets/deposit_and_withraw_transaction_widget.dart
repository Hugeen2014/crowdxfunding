...
import 'package:xfunding/controller/transaction_controller.dart';
...
class DepositAndWithdrawTransactionWidget extends StatelessWidget {
  DepositAndWithdrawTransactionWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        _selectorWidget(
            context, FontAwesomeIcons.ccPaypal, Strings.paypal, Strings.paypal),
        addVerticalSpace(10.h),
        _selectorWidget(
            context, FontAwesomeIcons.ccStripe, Strings.stripe, Strings.stripe),
        addVerticalSpace(10.h),
        _selectorWidget(context, FontAwesomeIcons.ccVisa, Strings.carNumber,
            Strings.carNumber),
        addVerticalSpace(10.h),
      ],
    );
  ...
  _selectorWidget(BuildContext context, IconData icon, String paymentMethodName,
