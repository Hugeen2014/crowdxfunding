...
class CategoriesSelectorWidget extends StatefulWidget {
  ...
  @override
  State<CategoriesSelectorWidget> createState() =>
      _CategoriesSelectorWidgetState();
}
    ...
    return SingleChildScrollView(
      ...
      child: FittedBox(
        ...
        child: Row(
          ...
          children: [
            _selectorWidget(
                context, Strings.categoriesImage, Strings.medical, 0),
            _selectorWidget(
                context, Strings.categoriesImage, Strings.education, 1),
            _selectorWidget(
                context, Strings.categoriesImage, Strings.church, 2),
            _selectorWidget(
                context, Strings.categoriesImage, Strings.disaster, 3),
            _selectorWidget(
                context, Strings.categoriesImage, Strings.funeral, 4),
          ],
        ),
      ),
    );
