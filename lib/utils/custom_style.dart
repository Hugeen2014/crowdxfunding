...
class CustomStyler {
  ...
  static var textFieldLableStyle = const TextStyle(
      color: CustomColor.whiteColor, fontSize: 16, fontWeight: FontWeight.w600);

  static var passwordHintTextStyle = const TextStyle(
      color: CustomColor.whiteColor, fontSize: 14, fontWeight: FontWeight.w600);
